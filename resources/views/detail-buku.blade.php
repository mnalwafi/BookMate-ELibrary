    ...
    <div class="container">
        ...
        <div class="all-details">
            <div class="cover">
                <div class="besar">
                    @if ($bookdata->cover)
                        <img src="{{ asset('storage/' . $bookdata->cover) }}" alt="">
                    @else
                        <img src="https://covers.openlibrary.org/b/isbn/{{ $bookdata->isbn }}-L.jpg" alt="">
                    @endif
                    <div class="pinjam-bookmark">
                        <button class="pinjam-buku">Download buku</button>
                        <div class="bookmark">
                            <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                                ...
                                <g filter="url(#filter0_i_146_780)">
                                    ...
                                    <path
                                        d="M33 19H23C21.9 19 21 19.9 21 21V37L28 34L35 37V21C35 19.9 34.1 19 33 19ZM33 34L28 31.82L23 34V22C23 21.45 23.45 21 24 21H32C32.55 21 33 21.45 33 22V34Z"
                                        fill="#094067" />
                                </g>
                                <defs>
                                    <filter id="filter0_i_146_780" x="0" y="0" width="56"
                                        ...
                                        <feColorMatrix type="matrix"
                                            values="0 0 0 0 0.0352941 0 0 0 0 0.25098 0 0 0 0 0.403922 0 0 0 0.25 0" />
                ...
                @if ($bookdata->cover)
                    <img src="{{ asset('storage/' . $bookdata->cover) }}" alt="" class="kecil">
                @else
                    <img src="https://covers.openlibrary.org/b/isbn/{{ $bookdata->isbn }}-L.jpg" alt=""
                        class="kecil">
                @endif
        ...
        <div class="review-rating">
            ...
            @if (count($reviewrating) > 3)
                <div class="semua-komen">
                    <a href="">
                        <p>Lihat semua komentar</p><svg width="13" height="8" viewBox="0 0 13 8" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12.5752 0.741667C12.9019 1.06844 12.9019 1.59823 12.5752 1.925L7.91438 6.58579C7.13333 7.36684 5.867 7.36684 5.08595 6.58579L0.425162 1.925C0.0983939 1.59823 0.0983944 1.06844 0.425163 0.741667V0.741667C0.751931 0.414899 1.28173 0.414899 1.6085 0.741667L6.50016 5.63333L11.3918 0.741666C11.7186 0.414898 12.2484 0.414899 12.5752 0.741667V0.741667Z"
                                fill="#3DA9FC" />
                        </svg>
                    </a>
                </div>
