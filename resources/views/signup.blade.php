                        ...
                        <div class="nama">
                            <div class="nama-depan">
                                ...
                                @error('name')
                                    is-invalid
                                @enderror">
                                    <input type="text" name="name" placeholder="Nama lengkap Anda" value="{{old('name')}}">
                                </div>
                                @error('name')
                            ...
                            <div class="nama-belakang">
                                ...
                                is-invalid
                                @enderror">
                                    <input type="text" name="username" placeholder="Username Anda" value="{{old('username')}}">
                                </div>
                                @error('username')
                                <div class="invalid-message">
                                    {{$message}}
                        ...
                        <div class="no-telp">
                            ...
                            @enderror
                             <label for="no-telp">
                                ...
                                <input type="text" name="phone-number" placeholder="(+62) 888 - 8888 - 8888" value="{{old('phone-number')}}">
                            </div>
                            @error('phone-number')
                                <div class="invalid-message">
                                    {{$message}}
