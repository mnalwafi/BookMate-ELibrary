    ...
    <div class="container">
        ...
        <div class="tab-option">
            <ul class="option-list">
                <li>
                    <a href="#buku-dipinjam">Buku Dipinjam</a>
                </li>
                <li>
                    <a href="#review-rating">Reviews & Ratings</a>
                </li>
                <li>
                    <a href="#buku-diunggah">Buku Diunggah</a>
                </li>
            </ul>
        </div>
        ...
        <div class="data-pengguna">
            ...
            <div class="ubah-data">
                <h3 id="button-ubah">Ubah data</h3>
                <svg id="button-ubah" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <form action="{{route('logout')}}" method="post" class="logout">
                <div class="keluar">
                @csrf
                    <h3 id="button-keluar">Keluar</h3>
                    <svg id="button-keluar" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="main-content">
            <div class="default" id="buku-dipinjam">
                <div class="buku">
                    <img src="" class="cover" alt="">
                    <div class="button">
                        <button class="button button-baca">Baca buku ini</button>
                        <button class="button button-kembalikan">Kembalikan sekarang</button>
                    </div>
                </div>
            </div>
