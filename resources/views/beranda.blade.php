                             ...
                             <a href="/book/{{ $bookrecommend[$i]->slug }}" class="cover">
                                 ...
                                 <div class="rating">
                                     <div class="scores">
                                         ...
                                         <div class="stars">
                                             @if (fmod($bookrecommend[$i]->AVG, 1) != 0.0)
                                                 @for ($j = 0; $j < floor($bookrecommend[$i]->AVG); $j++)
                                                     <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                         <g clip-path="url(#clip0_455_1102)">
                                                             <path
                                             ...
                                             @else
                                                 @for ($j = 0; $j < $bookrecommend[$i]->AVG; $j++)
                                                     <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                         <g clip-path="url(#clip0_455_1102)">
                                                             <path
                             ...
                             <a href="/book/{{ $bookpopular[$i]->slug }}" class="cover">
                                 ...
                                 <div class="rating">
                                     <div class="scores">
                                         ...
                                         <div class="stars">
                                             @if (fmod($bookpopular[$i]->AVG, 1) != 0.0)
                                                 @for ($j = 0; $j < floor($bookpopular[$i]->AVG); $j++)
                                                     <svg width="18" height="18" viewBox="0 0 18 18"
                                                         fill="none" xmlns="http://www.w3.org/2000/svg">
                                                         <g clip-path="url(#clip0_455_1102)">
                                                             <path
                             ...
                             <a href="/book/{{ $booklatest[$i]->slug }}" class="cover">
                                 ...
                                 <div class="rating">
                                     <div class="scores">
                                         ...
                                         <div class="stars">
                                             @if (fmod($booklatest[$i]->AVG, 1) != 0.0)
                                                 @for ($j = 0; $j < floor($booklatest[$i]->AVG); $j++)
                                                     <svg width="18" height="18" viewBox="0 0 18 18"
                                                         fill="none" xmlns="http://www.w3.org/2000/svg">
                                                         <g clip-path="url(#clip0_455_1102)">
                                                             <path
